...
{
    public class GetAllCatalogsQueryHandler : IRequestHandler<GetAllCatalogsQuery, IEnumerable<Catalog>>
    {
        ...
        public async Task<IEnumerable<Catalog>> Handle(GetAllCatalogsQuery request, CancellationToken cancellationToken)
        {
